...
- Submission: the existing HackSocial 2026 PolicyLens entry is recorded as submitted. The recorded deadline has passed; use `TODO.md` as the canonical tracker and verify live post-deadline edit permission before any Devpost update.
...
- [ ] If live post-deadline edits are permitted, add the demo video and captured screenshots to the existing Devpost entry.
